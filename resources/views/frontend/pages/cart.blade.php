								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>Rs :{{number_format($cart['amount'],2)}}</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">Rs :{{$cart['price']}}</span></td>
